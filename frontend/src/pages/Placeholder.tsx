  ...
  return (
    <div className='flex flex-row'>
      ...
      <div className='flex-1'>
        <section className="bg-gray-50 dark:bg-gray-900 ml-64">
          <div className="flex flex-row gap-10 items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div
              role="status"
